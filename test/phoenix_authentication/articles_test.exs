defmodule PhoenixAuthentication.ArticlesTest do
  use PhoenixAuthentication.DataCase

  alias PhoenixAuthentication.Articles

  describe "articles" do
    alias PhoenixAuthentication.Articles.Article

    import PhoenixAuthentication.ArticlesFixtures
