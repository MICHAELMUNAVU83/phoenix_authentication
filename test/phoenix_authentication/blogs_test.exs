defmodule PhoenixAuthentication.BlogsTest do
  use PhoenixAuthentication.DataCase

  alias PhoenixAuthentication.Blogs

  describe "blogs" do
    alias PhoenixAuthentication.Blogs.Blog

    import PhoenixAuthentication.BlogsFixtures
